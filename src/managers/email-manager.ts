...
export const emailsManager = {
    ...
    async reSendEmailConfirmationMessage(user: UserAccountDBType, newConfirmationCode: string) {
        await emailAdapter.sendEmail(user.accountData.email, "reSend", `<a href=https://some-front.com/confirm-registration?code=${newConfirmationCode}></a>`)
    }
}